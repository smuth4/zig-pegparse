...
const config = @import("tracy_config");

pub const enable = config.enable_tracy;
pub const enable_allocation = enable and config.enable_tracy_allocation;
pub const enable_callstack = enable and config.enable_tracy_callstack;
